...
LOG_DIRECTORY = './logs'
LOG_FILE_NAME = '{host_name}_{process_name}_{exec_timestamp}.log'
...
class LoggingSetup(object):
    ...
    def __init__(self, process_name, subdirectory=None, daily_file=True, console_level=None, file_level=None):
